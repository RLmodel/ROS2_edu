...
class NodeClass(Node):
    ...
    def timer_callback(self):
        ...
        self.get_logger().debug(f'=Hello ROS2 RLmodel example5: {self.count}=')
        self.get_logger().info(f'==Hello ROS2 RLmodel example5: {self.count}==')
        self.get_logger().warn(f'===Hello ROS2 RLmodel example5: {self.count}===')
        self.get_logger().error(f'====Hello ROS2 RLmodel example5: {self.count}====')
        self.get_logger().fatal(f'=====Hello ROS2 RLmodel example5: {self.count}====')
